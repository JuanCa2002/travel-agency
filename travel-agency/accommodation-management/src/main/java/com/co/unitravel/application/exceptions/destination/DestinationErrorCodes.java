...
public class DestinationErrorCodes {

    public static final String DESTINATION_ERROR_HEADER = "com.co.travel.application.exceptions.destination.DestinationErrorCodes.DESTINATION_ERROR_HEADER";
