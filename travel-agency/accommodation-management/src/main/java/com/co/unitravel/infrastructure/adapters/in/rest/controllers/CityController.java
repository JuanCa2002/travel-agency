...
public class CityController implements CityApi {
    ...
    @PostMapping
    @Override
    public ResponseEntity<CityResponse> save(CityRequest cityRequest) throws NotFoundException, BusinessException {
    ...
    @Override
    public ResponseEntity<List<CityResponse>> findByDepartment(@PathVariable Integer departmentId){
        var response = cityUseCase.getByDepartment(departmentId);
        return new ResponseEntity<>(cityMapperApi.domainsToResponses(response), HttpStatus.OK);
    }
}
